...
wget --no-check-certificate "https://tts.nuancemobility.net:443/NMDPTTSCmdServlet/tts?codec=wav&voice=samantha&text=Hello world. This is a greeting from Nuance.&appId=[INSERT YOUR APP ID]&appKey=[INSERT YOUR 128-BYTE STRING APP KEY]&id=0000" -O sample_audio_voice.wav -o test_results.log
